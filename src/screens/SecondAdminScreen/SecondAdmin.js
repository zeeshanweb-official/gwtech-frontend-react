...
import "./SecondAdmin.css";
import { Toast } from 'primereact/toast';
import AddSecondAdmin from './AddSecondAdminScreen/AddSecondAdminScreen';
import { InputText } from 'primereact/inputtext';
import CEOSidebar from '../../menus/CeoSidbarScreen';
import { useDispatch, useSelector } from 'react-redux';
import axios from "axios";

export  function SecondAdmin(){
    const instance = axios.create({
        baseURL: 'https://gwtech-node-app.herokuapp.com',
        headers: {
            Accept: "application/json",
            'content-type':'application/json',
            Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOjczLCJuYW1lIjoiR3cgVGVjaCIsImVtYWlsIjoiR3cgVGVjaEBnbWFpbC5jb20iLCJpYXQiOjE2NDU3OTI2MjMsImV4cCI6MTY0ODM4NDYyM30.dOxniV42MREKUgXXjTcoBx3p1EZPHd9L4ONkQsbOlto`
        },
    });
      ...
      <CEOSidebar />
        ...
        <div className='RA-13-rw-tp'>
                <div>
                    ...
                    <h1 className='RA-13-heading-data-table'>Add Second Admin</h1>
                    <a className='RA-13-bread-crumb'>CEO / Add-Second-Admin</a>
                    ...
                    <a onClick={() => addSecondAdmin()}>
                        ...
                        <DataTable value={adminData}  responsiveLayout="scroll" stripedRows className="mt-4">
                                  <Column header="Company ID" body={(data, props) => props.rowIndex+1}>                
                                  </Column>
                            {/* <Column field="_id" header="Company ID" sortable className="RA-13-datatable-p"></Column> */}
                            <Column field="name" header="Company Name" sortable className="RA-13-datatable-p"></Column>
                            <Column field="password" header="Password" sortable className="RA-13-datatable-p"></Column>
                            <Column field="address" header="Address" sortable className="RA-13-datatable-p"></Column>
                            <Column field="phone" header="Phone" sortable className="RA-13-datatable-p"></Column>
                            <Column  body={verifiedBodyTemplate2} header="Logo" sortable className="RA-13-datatable-p"></Column>
        ...
        <Sidebar visible={visible} onHide={() => setAdminSidebar(false)}  baseZIndex="10000" position="right" style={{width:'30em'}} >
            <AddSecondAdmin hitSidebar={succesRecord} adminId={adminId}/>
        </Sidebar>
      </>
